...
INSERT INTO category (code, name, `order`, description, active, icon_path, color_code)
VALUES ('programacao', 'Programação', 1,
        'Programe nas principais linguagens e plataformas. Iniciantes são bem vindos nos cursos de lógica e JavaScript.',
        1, 'https://www.alura.com.br/assets/api/formacoes/categorias/512/programacao-transparent.png', '#00c86f');
...
VALUES ('devops', 'DevOps', 2,
        ...
        1, 'https://www.alura.com.br/assets/api/formacoes/categorias/512/devops-transparent.png', '#f16165');

INSERT INTO category (code, name, description, active, icon_path, color_code)
VALUES ('business', 'Business', 'Agilidade. Práticas de gestão. Vendas. Liderança.', 0,
        'https://www.alura.com.br/assets/api/formacoes/categorias/512/inovacao-gestao-transparent.png', '#ff8c2a');

/* SUBCATEGORY */

INSERT INTO subcategory (code, name, `order`, description, active, category_code)
VALUES ('java', 'Java', 1,
...
INSERT INTO subcategory (code, name, `order`, active, category_code)
VALUES ('java-e-persistencia', 'Java e Persistência', 2,
        1, 'programacao');

INSERT INTO subcategory (code, name, `order`, description, active, category_code)
VALUES ('php', 'PHP', 3,
        'PHP é uma das linguagens mais utilizadas.',
        1, 'programacao');

INSERT INTO subcategory (code, name, active, category_code)
VALUES ('cobol', 'COBOL', 0, 'programacao');

INSERT INTO subcategory (code, name, `order`, description, active, category_code)
VALUES ('builds-e-controle-de-versao', 'Builds e Controle de versão', 1,
...
INSERT INTO course (code, name, estimated_hours_to_finish, visible, target_audience, instructor_name, syllabus,
                    developed_abilities, subcategory_code)
VALUES ('git-e-github-para-sobrevivencia', 'Git e Github para Sobrevivência', 6, 1,
        ...
        'builds-e-controle-de-versao');

INSERT INTO course (code, name, estimated_hours_to_finish, visible, target_audience, instructor_name, syllabus,
                    developed_abilities, subcategory_code)
VALUES ('java-jpa-consultas-avancadas-performance-modelos-complexos', 'Java e JPA: Consultas avançadas performance e modelos complexos', 10, 1,
...
INSERT INTO course (code, name, estimated_hours_to_finish, visible, target_audience, instructor_name, syllabus,
                    developed_abilities, subcategory_code)
VALUES ('java-introducao-orientacao-objetos', 'Java OO: Introdução à Orientação a Objetos', 8, 1,
...
INSERT INTO course (code, name, estimated_hours_to_finish, visible, target_audience, instructor_name, syllabus,
                    developed_abilities, subcategory_code)
VALUES ('java-primeiros-passos', 'Java JRE e JDK: Escreva o seu primeiro código com Eclipse', 8, 1,
...
VALUES (0, 'UNIQUE_ANSWER');

INSERT INTO question_type
VALUES (1, 'MULTIPLE_ANSWERS');

INSERT INTO question_type
VALUES (2, 'TRUE_OR_FALSE');